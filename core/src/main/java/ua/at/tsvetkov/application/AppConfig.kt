...
fun isInitializing(): Boolean {
    if (isInitialized) {
        ...
        Log.e("AppConfig is not initiated. Call ua.at.tsvetkov.application.AppConfig.init(application) in your Application code.")
        return false
    }
}
...
fun printInfo() {
    ...
    var infoString = " \n$LINE_DOUBLE\n" +
            ...
            "$LINE_DOUBLE\n" +
            "|                             Default Shared Preferences Data".padEnd(MAX_LENGTH, ' ').plus("|\n") +
            "$LINE_DOUBLE\n"
