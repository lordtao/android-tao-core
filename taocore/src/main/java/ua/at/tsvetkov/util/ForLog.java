...
public class ForLog {
    ...
    private static final String ARRAY_LINE = "-------------------------- Array --------------------------" + NL;
    ...
    /**
     * Return String representation of array. Each item in new line.
     *
     * @param array a array
     * @return String representation of map
     */
    ...
    /**
     * Return the String representing the current thread's stack.
     *
     * @return thread's stack String
     */
