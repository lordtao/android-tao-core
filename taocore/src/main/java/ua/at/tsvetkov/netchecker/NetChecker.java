...
public class NetChecker {
   ...
   /**
    * Check a web site status with {@link ua.at.tsvetkov.netchecker.NetChecker#DEFAULT_TIMEOUT }
    *
   ...
   public static NetStatus checkNet(Context context, final String urlStr) {
      if(context == null) {
         Log.e("Context can't be eq null");
         return null;
      }
      if (!isOnline(context)) {
    ...
    *
    * @param timeout timeout for check connection
    */
